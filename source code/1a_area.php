	...
	<?php
		/*	1 a. 
			Develop a PHP program to calculate areas of Triangle and 
			 Rectangle.			
		*/
						// variable names begin with $
		$base = 4;		// considering same base and height for both
		$height = 3; 	// triangle and rectangle
						// statements, expressions end in ;
		$area_of_tri = (1/2) * $base * $height;	// why is area of triangle
		$area_of_rect = $base * $height;		// half of rectangle
								// why is area of rectangle base * height
		// echo, function to print text, and value of variable
		// <br/> element of html, display text on a new line on web browser
		echo "<br/> For base = $base, and height = $height";
		echo "<br/> Area of triangle = $area_of_tri";
		echo "<br/> Area of rectangle = $area_of_rect";

		// Please observe change of color for variable names, functions
		//	provided program is being written in gedit, or 
		//	IDE that recognises PHP, like geany

		// Output of php code will be markup of html intended for web browser
	?>
	...
	<?php
		/*	Save program as
			...
			And access on Mozilla Firefox web browser
				through URL in address bar as
				
				http://localhost/1a_area.php
			
			Will work, if no syntax errors in PHP code			
		*/
		/*
			To check errors, on terminal, 
				but being in same working directory as program
					$ php 1a_area.php
			
			Can use tab key of keyboard to auto complete
				$ php				$ php 1a 
					and click tab, auto completes if unique name
				$ php 1a_area.php
					and enter ↵ 
					to check errors if any, or output on terminal		
		*/
	?>		
	<!-- This is comment in HTML, will not be displayed on web browser
			but is present in html markup, Right click, View Page Source		
	-->
	<?php
